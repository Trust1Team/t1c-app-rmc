...
.list-sub-group-item:hover {
  background-color: #d24d0d;
  color: white;
}

.list-sub-group-item:focus {
  background-color: #d24d0d;
  color: white;
}
...
.router-link-active .list-group-item {
