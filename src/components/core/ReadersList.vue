  ...
  <div class="readers-container" v-if="readers && readers.length > 0">
    <div v-for="reader in readers" v-bind:key="reader.id" class="reader-item">
      ...
      <div class="reader-module">
        ...
        <span class="span-row" v-else>{{ $t("readersList.No module detected") }}
          &nbsp;&nbsp;&nbsp;&nbsp;
          <div class="dropdown">
            <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            </button>
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <li v-for="module in modules" :key="module" class="dropdown-item" :value="module" @click="selectModule(reader ,module)">{{ module }}</li>
            </div>
          </div>
        </span>
