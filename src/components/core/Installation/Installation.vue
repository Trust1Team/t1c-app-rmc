<template>
  <div class="binaries-container">
    <div class="flex justify-evenly w-full my-5">
      <div class="alert alert-primary-soft show mb-2 flex items-center justify-center installation-alert" role="alert">
        {{ $t('installation.help') }}
      </div>
      <div class="refresh">
...
export default {
  ...
  setup() {
    ...
    const getUrl = () => window?._env_?.VUE_APP_T1C_URL || 'https://t1c.t1t.io';
    const getPort = () => window?._env_?.VUE_APP_T1C_PORT || 51783;
...
<style src="./Installation.style.css" scoped />
