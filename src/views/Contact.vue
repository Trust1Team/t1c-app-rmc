  ...
  <div>
    ...
    <div class="form">
      <form @submit.prevent>
        <div class="row">
          <div class="col-6">
            <input class="form-control" type="text" v-model="name" :placeholder="$t('contact.Name')" >
          </div>
          <div class="col-6">
            <input class="form-control" type="text" v-model="company" :placeholder="$t('contact.Company')" >
          </div>
        </div>
        <br>
        <div class="row">
          <div class="col-6">
            <input class="form-control" type="text" v-model="email" :placeholder="$t('contact.Email Address')" >
          </div>
          <div class="col-6">
            <input class="form-control" type="text" v-model="phoneNumber" :placeholder="$t('contact.Phone Number')" >
          </div>
        </div>
        <br>
        <div class="row">
          <div class="col-12">
            <textarea rows="5" class="form-control" v-model="message" :placeholder="$t('contact.Your message')" ></textarea>
          </div>
        </div>
        <br>
        <div class="row">
        ...
        <div class="row">
          <div class="col-12 float-right check-text">
            <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#validateModal">{{ $t('contact.Validation') }}</button>
          </div>
        </div>
      </form>
    </div>
    ...
    <div>
      <!--Validate Modal -->
      <div class="modal fade" id="validateModal" tabindex="-1" role="dialog" aria-labelledby="validateModalLabel" aria-hidden="true" ref="validateModal">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header text-center">
              <h5 class="modal-title m-lg-auto" id="validateModalLabel">{{ $t('contact.Get in Touch') }}</h5>
            ...
            <div class="modal-body">
              <div class="row float-left check-text" v-if="technicalCheck">
                <div class="col-1"><i class="fa fa-download fa-2x text-primary"></i></div>
              ...
              <div :class="technicalCheck ? 'col-11 m-auto' : ''">
                ...
                <div class="row float-left check-text">
                  <div class="col-1">
                    <input type="checkbox" id="t1tAgreement" name="t1tAgreement" v-model="t1tAgreement" class="form-check-input">&nbsp;
                  </div>
                  <div class="col-10">
            ...
            <div class="modal-footer">
              <button type="submit" @click.prevent="submitForm" class="btn btn-secondary m-auto"
                      :disabled="!(privacyPolicy&&termsCondition&&t1tAgreement)">{{ $t('contact.Submit') }}</button>
            </div>
          </div>
        </div>
      </div>
